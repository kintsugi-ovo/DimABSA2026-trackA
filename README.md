...
| 实验 | 模型 | 方法 | RMSE | 参数量(M) |
|------|------|------|------|-----------|
| Exp-A1 | Chinese-BERT base | - | 0.0701 | 102.27 |
| Exp-A2 | Chinese-RoBERTa base | - | 0.0729 | 102.27 |
| Exp-A3 | Chinese-RoBERTa | CNN | 0.0727 | 104.63 |
| Exp-A4 | Chinese-RoBERTa | LSTM | 0.0711 | 104.37 |
...
| Exp-B2 | P-Tuning | 0.0885 | 0.22% | 102.49 |
| Exp-B3 | LoRA+CNN | 0.0827 | 2.53% | 104.93 |
| Exp-B4 | LoRA+LSTM | 0.0804 | 2.29% | 104.67 |
